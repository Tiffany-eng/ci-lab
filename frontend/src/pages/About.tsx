...
const About = () => {
  return (
    <>
      <Helmet>
        <title>About CI Lab - Our Mission to Empower Digital Citizens</title>
        <meta 
          name="description" 
            ...
            <div className="container mx-auto px-4 relative z-10">
              ...
              >
                ...
                <p className="text-xl text-primary-foreground/80 leading-relaxed">
                  CI Lab was founded with a simple but powerful vision: to ensure every child 
                  has the knowledge and skills to navigate the digital world safely and responsibly.
                </p>
              </motion.div>
            </div>
          </section>
              ...
              <div className="grid md:grid-cols-2 gap-12">
                ...
                >
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    To empower children and teenagers with comprehensive digital literacy, 
                    cyber safety awareness, and AI understanding through engaging, practical 
                    education that prepares them for success in an increasingly digital world.
                  </p>
                </motion.div>
                ...
                >
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    A world where every young person is equipped with the knowledge, skills, 
                    and confidence to thrive online—making informed decisions, protecting their 
                    privacy, and contributing positively to digital communities.
                  </p>
                </motion.div>
              </div>
            </div>
            ...
            <div className="container mx-auto px-4">
              ...
              >
                ...
                <p className="text-lg text-muted-foreground leading-relaxed">
                  Children today are digital natives, yet most lack formal education about 

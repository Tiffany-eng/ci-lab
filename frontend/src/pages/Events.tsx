...
const Events = () => {
  return (
    <>
      <Helmet>
        <title>Events & Bootcamps - CI Lab Digital Literacy Workshops</title>
        <meta 
          name="description" 
          content="Join CI Lab's upcoming bootcamps and workshops. Intensive digital literacy programs for students of all ages. Register for our next event today!" 
        />
      </Helmet>

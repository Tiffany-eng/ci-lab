...
const Contact = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Contact CI Lab - Get in Touch With Our Team</title>
        <meta
          name="description"
          content="Contact CI Lab for partnership inquiries, program information, or general questions. We're here to help bring digital literacy education to your school or organization."
        />
      </Helmet>

...
const Partners = () => {
  return (
    <>
      <Helmet>
        <title>Partner With CI Lab - School Partnership Opportunities</title>
        <meta 
          name="description" 
          content="Partner with CI Lab to bring digital literacy education to your school. Multiple partnership models available including full programs, bootcamps, and CSR sponsorship." 
        />
      </Helmet>
              ...
              <div className="grid md:grid-cols-2 gap-12 items-center">
                ...
                >
                  <h2 className="font-display text-3xl md:text-4xl font-bold text-foreground mb-6">
                    Why Partner With CI Lab?
                  </h2>
                  <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
                    Partnering with CI Lab demonstrates your commitment to student safety 
            ...
            <div className="container mx-auto px-4">
              ...
              >
                <p className="text-primary-foreground/80 text-lg md:text-xl leading-relaxed mb-8 italic">
                  "Partnering with CI Lab has been transformative for our school. The program 
            ...
            <div className="container mx-auto px-4 text-center">
              ...
              >
                ...
                <p className="text-muted-foreground text-lg mb-8 max-w-2xl mx-auto">
                  Contact us today to discuss how CI Lab can support your school's 

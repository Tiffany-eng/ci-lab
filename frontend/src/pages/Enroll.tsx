...
const Enroll = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Enroll in CI Lab - Register for Digital Literacy Programs</title>
        <meta 
          name="description" 
          content="Register for CI Lab's digital literacy programs. Enrollment available for parents and schools. Secure your spot in our next program today." 
        />
      </Helmet>
              ...
              <div className="container mx-auto px-4">
                ...
                <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                  ...
                  >
                    ...
                    <p className="text-muted-foreground mb-4">
                      Bring CI Lab programs to your school or organization.
                    </p>
                          ...
                          <>
                            ...
                            <div className="space-y-2">
                              ...
                              >
                                ...
                                <option value="bootcamp">3-Day Bootcamp</option>
                                <option value="club">CI Club</option>
